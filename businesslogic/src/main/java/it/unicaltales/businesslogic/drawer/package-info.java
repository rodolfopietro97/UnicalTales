 ...
 * For example, if we want to use Swing/Awt, we make in 
 * our swing awt main classes the method that says to business
 * logic how to draw elements of business logic.
 */
