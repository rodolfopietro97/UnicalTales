...
/**
 * @author rodolfo
 * Class that manage SpriteEvents, such as a collision between two Sprites
 */
public class SpriteEvents {
	 ...
	 * @param s1: sprite 1
	 * @param s2: sprite 2
	 * @param collision: the function that say us what do if there is a collision between sprites
	 * @return if there is a y collision
	 */
	public boolean collision(Sprite s1, Sprite s2, OnSpriteCollision collision) {
	...
	/**
	 * Verify if mouse is over a sprite
	 * @param s: the sprite
	...
	/**
	 * Verify if mouse/touch clicks a sprite
	 * @param s: the sprite
	 * @param h: hardware events manager
	 * @return if mouse/touch clicks a sprite
	 */
