/**
 * @author rodolfo
 * This package contains the business logic Event Handlers.
 * In the game we know what are the type of events that wee need.
 * We know that in the game wee need only for example three keys or only mouses 
 * or touch.
