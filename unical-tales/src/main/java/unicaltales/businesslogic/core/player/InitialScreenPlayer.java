...
//				true));
	...
	public void onWindowsSizeChange() {
		...
		getSprite("btnExit").setPosition(new Position((GlobalValues.SIZE_WINDOW.getWidth() - 75),
				(GlobalValues.SIZE_WINDOW.getHeight())/76));
		...
		getSprite("playText").setPosition(new Position(GlobalValues.SIZE_WINDOW.getWidth() /4, 
				GlobalValues.SIZE_WINDOW.getHeight() - 115));
